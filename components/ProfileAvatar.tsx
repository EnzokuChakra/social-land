...
function ProfileAvatar({
  ...
  const shouldShowStoryRing = !isBlocked && (isCurrentUser || (!user.isPrivate && hasStories) || (user.isPrivate && user.followers?.some(follow => follow.followerId === session?.user?.id && follow.status === "ACCEPTED") && hasStories));
